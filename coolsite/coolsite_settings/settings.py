"""
Django settings for coolsite_settings project.
...
ROOT_URLCONF = 'coolsite_settings.urls'
...
WSGI_APPLICATION = 'coolsite_settings.wsgi.application'

ASGI_APPLICATION = 'coolsite_settings.asgi.application'
